async function faqCommand(ctx){
        try{
            await ctx.reply(`<b>1. How do we earn?</b>\nYou earn based on your credit score. Users who are the top 4% with their credit score will get a percentage cut from Ad R___.
...
<b>4. How often do we earn?</b>\nWhen ever the channel gets an Ad Contract you will be paid. 
For any inquires contact @donidev
`, {parse_mode: 'HTML'})
        }catch (e) {
            throw new Error(e);
        }
