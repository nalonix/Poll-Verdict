...
Every post will be validated if it's appropriate to be exposed to the public before
being posted. 
...
The top 4 credit owners will be get a percentage cut from Ad Revenue.`, {parse_mode: 'HTML'})
        }catch (e) {
            throw new Error(e);
        }
